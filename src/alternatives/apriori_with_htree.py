import csv, itertools, parameters, time
...
if __name__ == '__main__':
    ...
    while min_support > 0:
        ...
        frequent = apriori_generate_frequent_itemsets(transactions, min_support)
        a_rules = generate_association_rules(frequent, 0)
        end_time = time.time() - start_time
        with open("1000Comp.txt",'a') as output:
